...
/**
 * Directory that holds committed bake output (marketplace + plugin trees).
 *
 * Prefers the copy shipped inside the npm package, then the repository
 * checkout when running from a clone before sync.
 *
