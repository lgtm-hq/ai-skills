...
Match the tone of the existing reports in `~/Documents/security-audits/` — terse, factual, bulleted, no hedging.
...
- a long-form baseline audit report (different format, do not mimic)
- dated `YYYY-MM-DD-*.md` advisory reports (this is the format to match)
