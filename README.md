...
```bash
bunx skills add lgtm-hq/ai-skills@v0.12.0 -g
npx skills add lgtm-hq/ai-skills@v0.12.0 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.12.0 -g
```
...
```bash
gh release download v0.12.0 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx skills add lgtm-hq/ai-skills@v0.12.0 -g --all
```
