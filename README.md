...
```bash
bunx @lgtm-hq/ai-skills@0.9.1 install …
bunx @lgtm-hq/ai-skills@0.9.1 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.9.1 list
bunx @lgtm-hq/ai-skills@0.9.1 update …
bunx @lgtm-hq/ai-skills@0.9.1 remove …
bunx @lgtm-hq/ai-skills@0.9.1 adopt -y --project   # import skills-lock installs
```
...
```bash
bunx @lgtm-hq/ai-skills@0.9.1 install -y --global \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.9.1 -g
npx skills add lgtm-hq/ai-skills@v0.9.1 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.9.1 -g
```
...
```bash
gh release download v0.9.1 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx @lgtm-hq/ai-skills@0.9.1 install -y --global -a cursor \
  --bundle pre-push
...
bunx skills add lgtm-hq/ai-skills@v0.9.1 -g --all
```
...
```bash
bunx @lgtm-hq/ai-skills@0.9.1 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.9.1 list --global
bunx @lgtm-hq/ai-skills@0.9.1 remove -y --global -a cursor --skill lint
```
