...
matches the git tag, `@0.11.0` ↔ `v0.11.0`:

```bash
bunx --package=@lgtm-hq/ai-skills@0.11.0 skill
# or: bunx --package=@lgtm-hq/ai-skills@0.11.0 sk
```
...
```bash
bunx --package=@lgtm-hq/ai-skills@0.11.0 skill install -y --global \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.11.0 -g
npx skills add lgtm-hq/ai-skills@v0.11.0 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.11.0 -g
```
...
```bash
gh release download v0.11.0 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx --package=@lgtm-hq/ai-skills@0.11.0 skill install -y --global -a cursor \
  --vendor anthropics --skill frontend-design

# Escape hatch: all first-party skills via skills CLI
bunx skills add lgtm-hq/ai-skills@v0.11.0 -g --all
```

### Update installed skills

Prefer the gateway for installs it manages (globally installed → `skill`; for a
pinned, install-free run swap in `bunx --package=@lgtm-hq/ai-skills@0.11.0 skill`):
