...
git release tag (`@0.1.25` ↔ `v0.1.25`):

```bash
bunx @lgtm-hq/ai-skills@0.1.25
```
...
```bash
bunx @lgtm-hq/ai-skills@0.1.25 install …
bunx @lgtm-hq/ai-skills@0.1.25 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.1.25 list
bunx @lgtm-hq/ai-skills@0.1.25 update …
bunx @lgtm-hq/ai-skills@0.1.25 remove …
...
```bash
bunx @lgtm-hq/ai-skills@0.1.25 install -y --global -a cursor \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.1.25 -g
npx skills add lgtm-hq/ai-skills@v0.1.25 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.1.25 -g
```
...
```bash
gh release download v0.1.25 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx skills add lgtm-hq/ai-skills@v0.1.25 -g --all
```
...
```bash
bunx @lgtm-hq/ai-skills@0.1.25 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.1.25 list --global
bunx @lgtm-hq/ai-skills@0.1.25 remove -y --global -a cursor --skill lint
```
