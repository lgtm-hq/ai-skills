...
```bash
bunx --package=@lgtm-hq/ai-skills@0.30.3 sk install -y --global \
...
First-party gateway installs resolve `lgtm-hq/ai-skills@v0.30.3`.
...
```bash
gh release download v0.30.3 -R lgtm-hq/ai-skills -p skills-manifest.json
