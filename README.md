...
```bash
bunx skills add lgtm-hq/ai-skills@v0.1.22 -g
```
...
```bash
npx skills add lgtm-hq/ai-skills@v0.1.22 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.1.22 -g
```
...
```bash
gh release download v0.1.22 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx skills add lgtm-hq/ai-skills@v0.1.22 -g --all
