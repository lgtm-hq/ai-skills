...
```bash
bunx @lgtm-hq/ai-skills@0.11.0 install …
bunx @lgtm-hq/ai-skills@0.11.0 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.11.0 list
bunx @lgtm-hq/ai-skills@0.11.0 update …
bunx @lgtm-hq/ai-skills@0.11.0 remove …
bunx @lgtm-hq/ai-skills@0.11.0 adopt -y --project   # import skills-lock installs
```
...
```bash
bunx @lgtm-hq/ai-skills@0.11.0 install -y --global \
...
bunx @lgtm-hq/ai-skills@0.11.0 install -y --global -a cursor \
  --bundle pre-push
...
```bash
bunx @lgtm-hq/ai-skills@0.11.0 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.11.0 list --global
bunx @lgtm-hq/ai-skills@0.11.0 remove -y --global -a cursor --skill lint
```
