...
```bash
claude plugin marketplace add lgtm-hq/ai-skills@v0.30.2
...
```bash
bun add -g @lgtm-hq/ai-skills@0.30.2
...
```bash
bunx --package=@lgtm-hq/ai-skills@0.30.2 sk install -y --global \
...
First-party gateway installs resolve `lgtm-hq/ai-skills@v0.30.2`.
...
```bash
gh release download v0.30.2 -R lgtm-hq/ai-skills -p skills-manifest.json
