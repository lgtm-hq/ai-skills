...
git release tag (`@0.1.26` ↔ `v0.1.26`):

```bash
bunx @lgtm-hq/ai-skills@0.1.26
```
...
```bash
bunx @lgtm-hq/ai-skills@0.1.26 install …
bunx @lgtm-hq/ai-skills@0.1.26 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.1.26 list
bunx @lgtm-hq/ai-skills@0.1.26 update …
bunx @lgtm-hq/ai-skills@0.1.26 remove …
...
```bash
bunx @lgtm-hq/ai-skills@0.1.26 install -y --global -a cursor \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.1.26 -g
npx skills add lgtm-hq/ai-skills@v0.1.26 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.1.26 -g
```
...
```bash
gh release download v0.1.26 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx skills add lgtm-hq/ai-skills@v0.1.26 -g --all
```
...
```bash
bunx @lgtm-hq/ai-skills@0.1.26 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.1.26 list --global
bunx @lgtm-hq/ai-skills@0.1.26 remove -y --global -a cursor --skill lint
```
