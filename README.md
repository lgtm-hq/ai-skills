...
git release tag (`@0.9.3` ↔ `v0.9.3`):

```bash
bunx @lgtm-hq/ai-skills@0.9.3
```
...
```bash
bunx @lgtm-hq/ai-skills@0.9.3 install …
bunx @lgtm-hq/ai-skills@0.9.3 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.9.3 list
bunx @lgtm-hq/ai-skills@0.9.3 update …
bunx @lgtm-hq/ai-skills@0.9.3 remove …
bunx @lgtm-hq/ai-skills@0.9.3 adopt -y --project   # import skills-lock installs
```
...
```bash
bunx @lgtm-hq/ai-skills@0.9.3 install -y --global \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.9.3 -g
npx skills add lgtm-hq/ai-skills@v0.9.3 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.9.3 -g
```
...
```bash
gh release download v0.9.3 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx @lgtm-hq/ai-skills@0.9.3 install -y --global -a cursor \
  --bundle pre-push
...
bunx skills add lgtm-hq/ai-skills@v0.9.3 -g --all
```
...
```bash
bunx @lgtm-hq/ai-skills@0.9.3 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.9.3 list --global
bunx @lgtm-hq/ai-skills@0.9.3 remove -y --global -a cursor --skill lint
```
