...
git release tag (`@0.5.2` ↔ `v0.5.2`):

```bash
bunx @lgtm-hq/ai-skills@0.5.3
```
...
```bash
bunx @lgtm-hq/ai-skills@0.5.3 install …
bunx @lgtm-hq/ai-skills@0.5.3 vendors   # offline: baked vendors + SHAs
bunx @lgtm-hq/ai-skills@0.5.3 list
bunx @lgtm-hq/ai-skills@0.5.3 update …
bunx @lgtm-hq/ai-skills@0.5.3 remove …
bunx @lgtm-hq/ai-skills@0.5.3 adopt -y --project   # import skills-lock installs
```
...
```bash
bunx @lgtm-hq/ai-skills@0.5.3 install -y --global -a cursor \
...
```bash
bunx skills add lgtm-hq/ai-skills@v0.5.3 -g
npx skills add lgtm-hq/ai-skills@v0.5.3 -g
pnpm dlx skills add lgtm-hq/ai-skills@v0.5.3 -g
```
...
```bash
gh release download v0.5.3 -R lgtm-hq/ai-skills -p skills-manifest.json
...
bunx skills add lgtm-hq/ai-skills@v0.5.3 -g --all
```
...
```bash
bunx @lgtm-hq/ai-skills@0.5.3 update -y --global -a cursor
bunx @lgtm-hq/ai-skills@0.5.3 list --global
bunx @lgtm-hq/ai-skills@0.5.3 remove -y --global -a cursor --skill lint
```
